  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        <h2>Privacy Policy for MitoDerm</h2>
        ...
        <p>
          ...
          use, protect, and disclose information obtained through our website
          (the "Site"). It applies to all individuals who access or use our
          Site, regardless of their place of residence, and reflects our
          compliance with applicable laws and regulations, including, where
          relevant, the Israeli Protection of Privacy Law, 5741-1981, the
          European Union’s General Data Protection Regulation (GDPR), and other
        ...
        <p>
          ...
          voluntarily provide when interacting with our Site. Such information
          may include:
        </p>
        <p>
        ...
        <p>
          ...
          Similar Technologies: Data collected through cookies, pixels, and
          other tracking technologies to enhance user experience, analyze usage,
          and for certain marketing activities (as described in Section 6). 1.3
          Usage Data: We collect information regarding how you interact with our
          Site, such as the pages viewed, time spent on the Site, navigation
          patterns, and features used, to improve our services and user
          experience.
        </p>
        ...
        <p>
          We use the information we collect for the following purposes and on
          the following legal bases:
        </p>
        <p>
          Service Provision and Customer Support: To respond to inquiries,
          process requests, improve our Site’s functionality, provide you with
          information or services, and carry out contractual obligations.
          Marketing and Communications: To send you newsletters, promotional
          materials, and other marketing communications, subject to your
          explicit consent or other lawful bases under applicable law. Analytics
          and Improvement: To analyze user behavior, measure engagement, conduct
          research, and improve our Site, products, and services. Legal and
          Regulatory Compliance: To comply with applicable laws, regulations,
          and industry standards, respond to lawful requests, enforce our terms,
          or protect our rights, property, and the safety of our users or third
          parties. Where required by law, we rely on your consent or other
          lawful bases such as the necessity to perform a contract or comply
          with legal obligations to process your personal data.
        </p>
        ...
        <p>
          ...
          required or permitted by law, regulatory requirements, or pursuant to
          a lawful request by public authorities (including to meet national
          security or law enforcement requirements), or to protect our rights
        ...
        <p>
          ...
          the purposes for which it was collected, as described in this Policy,
          or as required by applicable law. When data is no longer needed, we
          take steps to securely delete, anonymize, or otherwise render it
          inaccessible.
        </p>
        <p>5. Your Rights</p>
        <p>
        ...
        <p>
          ...
          we process your personal data and request a copy of the personal data
          we hold about you. Right to Rectification: The right to correct any
          ...
          and machine-readable format, and to request the transfer of that data
          to another data controller where technically feasible. Right to
          Object: The right to object, on legitimate grounds, to the processing
          of your personal data, including for direct marketing purposes. Right
          to Withdraw Consent: If we process your personal data based on your
          consent, the right to withdraw that consent at any time without
          affecting the lawfulness of processing conducted prior to withdrawal.
          To exercise your rights, please contact us at policy@mitoderm.com. We
          may request additional information to verify your identity and will
        ...
        <p>
          ...
          accessibility. Performance and Analytics Cookies: Help us understand
          how visitors interact with our Site, allowing us to improve
          functionality and user experience. Marketing and Advertising Cookies:
          Used to personalize marketing messages and track the effectiveness of
          our promotional campaigns, only with your explicit consent where
          required by law. You can manage your cookie preferences through your
          browser settings or our cookie preference tool, if available. For
          additional details, please see our Cookie Policy.
        </p>
        <p>7. Data Security</p>
        <p>
          ...
          disclosure, or access. Despite these measures, no method of
        ...
        <p>
          ...
          other than your country of residence, including Israel and
          jurisdictions that may not provide the same level of data protection
          as your home country. In such cases, we take measures to ensure that
          your personal data receives an adequate level of protection, for
          instance by implementing appropriate contractual safeguards (such as
          EU Standard Contractual Clauses where required).
        </p>
        <p>9. Third-Party Links</p>
        <p>
          Our Site may contain links to third-party websites or resources that
          are not controlled or operated by us. This Policy does not apply to
          third-party websites. We encourage you to review the privacy policies
          of those third parties to understand their data handling practices
        ...
        <p>
          ...
          constitute acceptance of those changes. We encourage you to review
          this Policy periodically for the latest information on our privacy
          practices.
        </p>
        <p>11. Contact Us</p>
        <p>
